...
<body>
    <main>
        <section class="login   d-flex  align-items-center justify-content-center">
            <form action="../../index.php" method="post" class=" d-flex flex-column bg-white w-25 p-4 rounded border border-2" autocomplete="off">
                <img src="../public/img/hominis-logo.png" alt="Logo de ericin" class=" img-fluid w-50 m-auto">
