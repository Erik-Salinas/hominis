            ...
            <div class="offcanvas offcanvas-start text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-start flex-grow-1 pe-3">
                        <li class="nav-item">
                            <a class="nav-link fs-5 <?= !isset($_GET['action']) ? 'active' : '' ?>" href="/hominis/mvc/resources/views/home.php">Inicio</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fs-5 <?= isset($_GET['action']) && $_GET['action'] == 'affiliates' ? 'active' : '' ?>" href="/hominis/mvc/resources/views/affiliates.php?action=affiliates">Afiliados</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fs-5 <?= isset($_GET['action']) && $_GET['action'] == 'record' ? 'active' : '' ?>" href="/hominis/mvc/resources/views/record.php?action=record">Afiliarte</a>
                        </li>
                        <li class="nav-item">
