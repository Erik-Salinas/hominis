...
foreach ($afiliados as $afiliado) {
    ...
    echo "<td><a href='/hominis/mvc/index.php?action=delet&dni={$afiliado['dni']}' onclick='return confirm(\"¿Estás seguro de que deseas eliminar este afiliado?\");'><i class='bi bi-trash'></i></a></td>";
    echo "</tr>";
}
?>
                </tbody>
